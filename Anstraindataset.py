...
try:
    ...
    w1 = open(
        model_folder + "/" + "best_layer1_weights" + model_name_load + ".npy", "rb"
    )
    b1 = open(
        model_folder + "/" + "best_layer1_biases" + model_name_load + ".npy", "rb"
    )
    w2 = open(
        model_folder + "/" + "best_layer2_weights" + model_name_load + ".npy", "rb"
    )
    b2 = open(
        model_folder + "/" + "best_layer2_biases" + model_name_load + ".npy", "rb"
    )
    w3 = open(
        model_folder + "/" + "best_layer3_weights" + model_name_load + ".npy", "rb"
    )
    b3 = open(
        model_folder + "/" + "best_layer3_biases" + model_name_load + ".npy", "rb"
    )
    w4 = open(
        model_folder + "/" + "best_layer4_weights" + model_name_load + ".npy", "rb"
    )
    b4 = open(
        model_folder + "/" + "best_layer4_biases" + model_name_load + ".npy", "rb"
    )
    ...
    print("loading loss ")
    best_loss_filer = open(
        model_folder + "/" + "best_loss" + model_name_load + ".txt", "r"
    )
